...
#The following modules need to import before handling gstreamer api
import gobject
import sys
import pygst
pygst.require('0.10')
...
class Speech_Recog(object):
	...
	def init_gst(self):
		#The following code create a gstreamer pipeline with pipeline description. The required descriptors needed
		#for the code is given as parameters.
	...
	def start_recognition(self):
		#VADER - Voice Activity DEtectoR, which helps when the 	speech start and when its ends. Creating VADER object and set the
		# property silent to False, so no speech will detected until key press
